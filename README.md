...
Used for Project to build database.
Project Scope:
...
Users:
In this theoretical scenario users would be mebers of law enforcements who can track and analyze crimes based on patterns.
Such as with copycat killers or killers who belong to similar groups (Extreme groups)
